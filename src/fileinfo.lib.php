...
class GddysecFileInfo extends Gddysec
{
     ...
     *
     * @see GddysecFSScanner.getIgnoredDirectories()
     * @var array
     */
    ...
    public function getDirectoryTree($directory = '', $filterby = 'file')
    {
        ...
        if (is_dir($directory) && self::isSplAvailable()) {
            ...
            $this->ignored_directories = GddysecFSScanner::getIgnoredDirectories();
        ...
        return array_map(array('Gddysec', 'fixPath'), $files);
    }
    ...
    public function removeDirectoryTree($directory = '')
    {
        ...
        if (is_array($dir_tree) && !empty($dir_tree)) {
            ...
            usort($dir_tree, array('GddysecFileInfo', 'sortByLength'));
