...
<table border="1" cellspacing="1" cellpadding="5">
    <thead>
        <tr>
            <th colspan="5">
                Core integrity (%%GDDYSEC.CoreFiles.ListCount%% files)
            </th>
        </tr>
        ...
        <tr>
            <td colspan="5">
                <p>
                    ...
                    <a href="%%GDDYSEC.URL.Scanner%%">malware scan</a> tool. If you see the
                    ...
                    this tool. Access the <a href="%%GDDYSEC.URL.Home%%">admin area</a> of
