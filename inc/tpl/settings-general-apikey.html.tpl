...
<div class="gddysec-boxshadow">
    ...
    <div class="inside">
        ...
        <div class="gddysec-inline-alert-warning gddysec-%%GDDYSEC.InvalidDomainVisibility%%">
            <p>
                Your domain <code>%%GDDYSEC.CleanDomain%%</code> does not seems to have a DNS
        ...
        <div class="gddysec-%%GDDYSEC.APIKey.RecoverVisibility%%">
            <div class="gddysec-hstatus">
                <div class="gddysec-monospace">Plugin API Key: %%GDDYSEC.APIKey%%</div>
                <form action="%%GDDYSEC.URL.Settings%%" method="post">
                    <input type="hidden" name="gddysec_page_nonce" value="%%GDDYSEC.PageNonce%%" />
                    <button type="submit" name="gddysec_recover_key" class="button-primary">Recover Via E-mail</button>
                </form>
            </div>
            ...
            <p>
                ...
                href="%%GDDYSEC.URL.Settings%%&recover">click this link</a> to activate
                the plugin manually. Be aware that if the key is invalid the plugin will
                delete it afterwards.
            </p>
        </div>

        <div class="gddysec-hstatus gddysec-%%GDDYSEC.APIKey.RemoveVisibility%%">
            <div class="gddysec-monospace">Plugin API Key: %%GDDYSEC.APIKey%%</div>
            <form action="%%GDDYSEC.URL.Settings%%" method="post">
                <input type="hidden" name="gddysec_page_nonce" value="%%GDDYSEC.PageNonce%%" />
                <button type="submit" name="gddysec_remove_api_key" class="button-primary button-danger">Remove</button>
            </form>
        </div>
    </div>
</div>
