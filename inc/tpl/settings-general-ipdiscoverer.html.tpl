...
<div class="gddysec-boxshadow">
    ...
    <div class="inside">
        ...
        <div class="gddysec-hstatus">
            <span>IP Address Discoverer is %%GDDYSEC.DnsLookupsStatus%%</span>
            ...
            <form action="%%GDDYSEC.URL.Settings%%" method="post">
                ...
                <button type="submit" class="button-primary %%GDDYSEC.DnsLookupsSwitchCssClass%%">
                    %%GDDYSEC.DnsLookupsSwitchText%%
                </button>
            </form>
        </div>
        ...
        <div class="gddysec-hstatus gddysec-monospace">
            <div>CloudProxy is %%GDDYSEC.IsUsingCloudProxy%%</div>
            <div>Website URL: %%GDDYSEC.WebsiteURL%%</div>
            <div>Top Level Domain: %%GDDYSEC.TopLevelDomain%%</div>
            <div>Website Hostname: %%GDDYSEC.WebsiteHostName%%</div>
            <div>Website Host Address: %%GDDYSEC.WebsiteHostAddress%%</div>
            <div>IP Address: %%GDDYSEC.RemoteAddress%% (%%GDDYSEC.RemoteAddressHeader%%)</div>
        </div>
    </div>
</div>
