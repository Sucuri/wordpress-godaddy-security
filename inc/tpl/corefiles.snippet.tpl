...
<tr class="%%SUCURI.Integrity.CssClass%%">
    <td class="check-column">
        <input type="checkbox" name="gddysec_corefiles[]" value="%%SUCURI.Integrity.StatusType%%@%%SUCURI.Integrity.FilePath%%" />
    </td>

    <td>
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="15.5px" height="18.5px" class="gddysec-corefiles-%%SUCURI.Integrity.StatusType%%" title="%%SUCURI.Integrity.StatusType%%">
    ...
    <td><em title="%%SUCURI.Integrity.FileSizeNumber%% bytes">%%SUCURI.Integrity.FileSizeHuman%%</em></td>

    <td>%%SUCURI.Integrity.ModifiedAt%%</td>

    <td>
        <span class="gddysec-monospace gddysec-wraptext">%%SUCURI.Integrity.FilePath%%</span>
