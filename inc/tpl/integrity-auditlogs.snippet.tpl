...
<tr class="%%GDDYSEC.AuditLog.CssClass%%">
    <td>
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="15.5px" height="18.5px" class="gddysec-auditlog-%%GDDYSEC.AuditLog.Event%%" title="%%GDDYSEC.AuditLog.EventTitle%%">
    ...
    <td>
        <div>%%GDDYSEC.AuditLog.DateTime%%</div>

        <div class="gddysec-monospace">Username: %%GDDYSEC.AuditLog.Username%%</div>

        <div class="gddysec-monospace">IP Address: %%GDDYSEC.AuditLog.RemoteAddress%%</div>

        <div>%%GDDYSEC.AuditLog.Message%%</div>
