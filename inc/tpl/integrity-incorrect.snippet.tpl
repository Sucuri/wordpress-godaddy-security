...
<tr>
    <th class="check-column">
        <input type="checkbox" name="gddysec_integrity[]" value="%%GDDYSEC.Integrity.StatusType%%@%%GDDYSEC.Integrity.FilePath%%" />
    </th>

    <td>
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="15.5px" height="18.5px" class="gddysec-integrity-%%GDDYSEC.Integrity.StatusType%%">
        ...
        <span class="gddysec-hidden">%%GDDYSEC.Integrity.StatusType%%</span>
    </td>

    <td><span title="%%GDDYSEC.Integrity.FileSizeNumber%% bytes">%%GDDYSEC.Integrity.FileSizeHuman%%</span></td>

    <td>%%GDDYSEC.Integrity.ModifiedAt%%</td>

    <td class="gddysec-integrity-filepath" data-filepath="%%GDDYSEC.Integrity.FilePath%%">
        <span class="gddysec-monospace gddysec-wraptext">%%GDDYSEC.Integrity.FilePath%%</span>

        <span class="gddysec-tooltip gddysec-%%GDDYSEC.Integrity.ErrorVisibility%%" content="%%GDDYSEC.Integrity.ErrorMessage%%">
