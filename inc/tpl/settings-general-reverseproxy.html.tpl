...
<div class="gddysec-boxshadow">
    ...
    <div class="inside">
        ...
        <div class="gddysec-hstatus">
            <span>Reverse Proxy Support is %%GDDYSEC.ReverseProxyStatus%%</span>
            ...
            <form action="%%GDDYSEC.URL.Settings%%" method="post">
                ...
                <button type="submit" class="button-primary %%GDDYSEC.ReverseProxySwitchCssClass%%">
                    %%GDDYSEC.ReverseProxySwitchText%%
                </button>
            </form>
        </div>
    </div>
