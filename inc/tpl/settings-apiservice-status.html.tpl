...
<div class="gddysec-panel">
    ...
    <div class="inside">
        ...
        <div class="gddysec-inline-alert-error gddysec-%%GDDYSEC.ApiStatus.ErrorVisibility%%">
            <p>Disabling the API service communication will stop the event monitoring, consider to enable the <a href="%%GDDYSEC.URL.Settings%%#general">Log Exporter</a> to keep the monitoring working while the HTTP requests are ignored, otherwise an attacker may execute an action that will not be registered in the security logs and you will not have a way to investigate the attack in the future.</p>
        </div>
